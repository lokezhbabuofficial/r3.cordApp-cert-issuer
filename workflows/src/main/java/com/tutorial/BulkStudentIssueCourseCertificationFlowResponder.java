...
@InitiatedBy(BulkStudentIssueCourseCertificationFlowInitator.class)
public class BulkStudentIssueCourseCertificationFlowResponder implements Flow<SignedTransaction> {
